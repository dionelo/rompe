...
var instrucciones = ['Utilizar las flechas para mover las piezas.', 'Ordenar las piezas hasta conseguir formar la imagen completa.'];
...
function chequearSiGano() {
    ...
    for(var i=0; i<grilla.length; i++) {
      ...
      for(var j=0; j<fila.length; j++) {
        var numeroDeLagrilla = grilla[i][j];
        if(numeroDeLagrilla == numeroDelRompecabezasCompleto){
          numeroDelRompecabezasCompleto++;      
